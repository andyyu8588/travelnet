(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        _createClass(FriendlistService, [{
          ...
          value: function getList(array) {
            ...
            this.SocketService.emit('searchChatroom', {
              ...
              _this._chatroomList.next(_this.roomarr);
          ...
          value: function CreateChatroom(users) {
            ...
            this.SocketService.emit('searchUser', polishedarr, function (data) {
              if (data.err) {
                ...
                _this3.SocketService.emit('createChatroom', polishedarr.sort());
              }
          ...
          value: function getNotifications() {
            ...
            this.SocketService.listen('notification').subscribe(function (data) {
              if (data.res) {
                var i = _this4.roomarr.findIndex(function (e) {
                ...
                if (data.res.action == 'message') {
                  if (i != -1) {
                    ...
                    if (data.res.sender == sessionStorage.getItem('username')) {
                      _this4.roomarr[i].unread = false;
                    } else {
                      _this4.roomarr[i].unread = true;
                    }

                    _this4._chatroomList.next(_this4.roomarr);
                  } else {
          ...
          value: function selectChatwidget(roomId) {
            ...
            this.SocketService.emit('initChatroom', {
              ...
              if (data) {
                var i = _this5.roomarr.findIndex(function (e) {
                  return e.roomId === roomId;
                });

                _this5.roomarr[i].unread = false;

                _this5._chatroomList.next(_this5.roomarr);
              }
            });
          }
        }, {
          ...
          value: function resizeWindow(width) {
            ...
            if (this.widgetarr.length > MAXNUM) {
              var _loop = function _loop(x) {
                var removedRoomId = _this6.idarr[0];

                _this6.roomarr.forEach(function (room) {
                  if (room.roomId == removedRoomId) {
                    room.open = false;
                  }
                });

                _this6.widgetarr.shift();
        ...
        _createClass(FilterComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.categoriesSet_sub = this.SearchService.categorySet.subscribe(function (set) {
              return _this7.categoriesSet = set;
            });
            this.categoriesTree_sub = this.SearchService.categoryTree.subscribe(function (tree) {
              if (tree) {
                _this7.categoriesTree = tree; // sets category filter from url params

                _this7.ActivatedRoute.queryParams.subscribe(function (params) {
                  if (params.category) {
                    if (params.category === 'All') {
                      null;
                    } else {
                      _this7.categoriesTree.forEach(function (child) {
                        if (child.name != params.category) {
                          _this7.uncheckAll(child.categories);
                        } else {
                          _this7.checkAll(child.categories);
                        }
                      });
                    }
                  }
          ...
          value: function checkAll(categories) {
            ...
            categories.forEach(function (sub) {
              sub.checked = true;
              _this8.SearchService.treeValues.categorySet.has(sub.id) ? null : _this8.SearchService.treeValues.categorySet.add(sub.id);

              _this8.SearchService.updateCategorySet(_this8.categoriesSet); // this.modifyIdSet(sub)


              if (sub.categories && sub.categories.length > 0) {
                _this8.checkAll(sub.categories);
              }
            });
          }
          ...
          value: function uncheckAll(categories) {
            ...
            categories.forEach(function (sub) {
              sub.checked = false;
              _this9.SearchService.treeValues.categorySet.has(sub.id) ? _this9.SearchService.treeValues.categorySet["delete"](sub.id) : null; // this.modifyIdSet(sub)

              if (sub.categories && sub.categories.length > 0) {
                _this9.uncheckAll(sub.categories);
              }
            });
          }
          ...
          value: function allChildrenChecked(categories, state) {
            ...
            categories.forEach(function (child) {
              if (!state) {
                ...
                state = _this10.allChildrenChecked(child.categories, state);
          ...
          value: function atLeastOneChecked(categories, state) {
            ...
            categories.forEach(function (child) {
              if (state) {
                ...
                state = _this11.atLeastOneChecked(child.categories, state);
              } else if (child.checked) {
                state = true;
                return state;
              }
    ...
    /***/
    function mFC(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var MytripComponent = /*#__PURE__*/function () {
        ...
        _createClass(MytripComponent, [{
          ...
          value: function getTotalPrice(obj) {
            ...
            if (obj.schedule) {
              obj.schedule.forEach(function (element) {
                total += _this12.getDayPrice(element);
              });
            }
          ...
          value: function getTotalVenues(obj) {
            ...
            if (obj.schedule) {
              obj.schedule.forEach(function (element) {
                total += _this13.getDayVenues(element);
              });
            }
          ...
          value: function ngOnInit() {
            ...
            this.ActivatedRoute.queryParams.subscribe(function (params) {
              if (params.tripId) {
                ...
                _this14.HttpService.get('/trips', {
                  tripId: params.tripId
                }).then(function (res) {
                  _this14.sharedTrip = res.trip;
                })["catch"](function (err) {
                  console.log(err);
                })["finally"](function () {});
              }
          ...
          value: function openAddTripModal() {
            ...
            this.dialogRef.afterClosed().subscribe(function (result) {
              if (result) {
                _this16.trips.push(result);

                _this16.TripService.updateLocal(_this16.trips);
              }
            });
          }
          ...
          value: function onListDrop(event, tripIndex, dayIndex) {
            ...
            this.TripService.modifyBackend(this.trips).then(function (res) {
              _this17.table.renderRows();

              _this17.isSuccess = true;
            })["catch"](function () {
              _this17.isErr = true;
            })["finally"](function () {
              _this17.isLoading = false;
              setTimeout(function () {
                _this17.isSuccess = false;
                _this17.isErr = false;
              }, 1000);
            });
          }
          ...
          value: function showItinerary(tripIndex, shared) {
            ...
            var _iterator = _createForOfIteratorHelper(obj.schedule),
                _step;
              ...
              for (_iterator.s(); !(_step = _iterator.n()).done;) {
                ...
                day.venues.forEach(function (venue) {
                  if (venue.venueCoord) {
                    ...
                    _this20.MapService.showMarker(1, {
                      name: venue.name,
                      content: {
                        geometry: {
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! D:\Desktop\travelnet\frontend\src\main.ts */
      "zUnb");
      /***/
    },
    ...
    /***/
    function CGX(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var HeaderComponent = /*#__PURE__*/function () {
        function HeaderComponent(sessionService) {
          ...
          this.sessionState_sub = this.sessionService.sessionState.subscribe(function (username) {
            _this22.sessionState = username;

            if (username) {
              _this22.username = sessionStorage.getItem('username');
            } else {
              _this22.username = '';
            }
          });
    ...
    /***/
    function AFk(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function eJP(module, __webpack_exports__, __webpack_require__) {
      ...
      var AddTagComponent = /*#__PURE__*/function () {
        ...
        _createClass(AddTagComponent, [{
          ...
          value: function onAddTag(username, tag) {
            this.http.put(src_environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].travelnetURL + "api/user/addTag/", {
              'username': username,
              'tag': tag
      ...
      AddTagComponent.ɵfac = function AddTagComponent_Factory(t) {
        return new (t || AddTagComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"]));
      };

      AddTagComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        ...
        template: function AddTagComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("submit", function AddTagComponent_Template_form_submit_0_listener() {
              return ctx.onSubmit();
            });
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](AddTagComponent, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"],
          args: [{
    ...
    /***/
    function ghV(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function A62(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function W9C(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function AALG(module, __webpack_exports__, __webpack_require__) {
      "use strict";
        ...
        _createClass(CountrySelectorComponent, [{
          ...
          value: function ngAfterContentInit() {
            ...
            this.clickLocation_sub = this.MapService.clickLocation.subscribe(function (x) {
              if (_this23.progressUpdate && _this23.target == _this23.progressUpdate) {
                if (x.lng != null) {
                  _this23.Http.get(_environments_environment_prod__WEBPACK_IMPORTED_MODULE_0__["environment"].mapbox.geocoding.concat('/', x.lng.toString(), ',', x.lat.toString(), '.json'), {
                    headers: {},
                    params: {
                    ...
                    if (response.features[0]) {
                      ...
                      var chip = _this23.citySearchComponent.removeMiddle(placeName, 1);

                      _this23.getKey(response.features[response.features.length - 1].properties.short_code.toUpperCase()).then(function (value) {
                        var continent = value.continent;

                        _this23.allPlaces.forEach(function (element) {
                          if (element.code === continent && !element.places.includes(chip)) {
                            element.places.push(chip);

                            _this23.MapService.showMarker(_this23.target, {
                              name: chip,
                              content: {
                                geometry: {
          ...
          value: function ngAfterViewInit() {
            ...
            this.optionClick_sub = this.citySearchComponent.clickedOption.subscribe(function (content) {
              if (content) {
                ...
                var chip = _this24.citySearchComponent.removeMiddle(content.name, 1);
                ...
                _this24.getKey(code).then(function (value) {
                  var continent = value.continent;
                ...
                content.name = _this24.citySearchComponent.removeMiddle(content.name, 1);

                _this24.MapService.showMarker(_this24.target, content);
              }
            });
          ...
          value: function onSumbit() {
            ...
            return new Promise(function (resolve, reject) {
              _this25.HttpService.patch('/user/edit', {
                username: localStorage.getItem('username').toString(),
                proprety: _this25.target == 1 ? 'history' : 'wishlist',
                newProprety: _this25.allPlaces
    ...
    /***/
    function AKBL(module, __webpack_exports__, __webpack_require__) {
      "use strict";
        ...
        _createClass(MyaccountComponent, [{
          ...
          value: function onImagePicked(event) {
            ...
            reader.onload = function () {
              _this26.imagePreview = reader.result.toString();
            };
    ...
    /***/
    function ApTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function Awxy(module, __webpack_exports__, __webpack_require__) {
      "use strict";
        ...
        _createClass(FriendlistComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.sessionSub = this.SessionService.sessionState.subscribe(function (isLoggedIn) {
              _this27.sessionState = isLoggedIn;

              if (isLoggedIn) {
                _this27.friendsSub = _this27.friendlistService.chatroomList.subscribe(function (friends) {
                  return _this27.friends = friends;
                });

                _this27.friendlistService.getList([]);
              } else {
    ...
    function AytR(module, __webpack_exports__, __webpack_require__) {
      ...
      "FvPJ"); // This file can be replaced during build by using the `fileReplacements` array.
    ...
    /***/
    function Bg0t(module, __webpack_exports__, __webpack_require__) {
      "use strict";
        ...
        _createClass(VenueComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.SearchService.formatDetails(this.url).then(function (result) {
              console.log(result);
              _this28.content = result.response.venue;

              if (_this28.content.rating && _this28.content.ratingColor) {
                _this28.rating = _this28.content.rating;
                _this28.ratingColor = "#".concat(_this28.content.ratingColor);
              }
            });
          }
          ...
          value: function addToTrip(event) {
            ...
            if (event.length && this.trips) {
              event.map(function (option) {
                _this29.trips[option.value.trip].schedule[option.value.day].venues.push({
                  name: _this29.content.name ? _this29.content.name : null,
                  venueAddress: _this29.content.location.formattedAddress ? _this29.content.location.formattedAddress.join(' ') : null,
                  venueCoord: _this29.content.location.lng ? {
                    lng: _this29.content.location.lng,
                    lat: _this29.content.location.lat
                  } : null,
                  venueCity: _this29.content.location.city ? _this29.content.location.city : null,
                  url: _this29.content.canonicalUrl ? _this29.content.canonicalUrl : null,
                  category: _this29.content.categories[0] ? {
                    name: _this29.content.categories[0].name,
                    url: _this29.content.categories[0].icon.prefix + '32' + _this29.content.categories[0].icon.suffix
                  } : null
                });
              });
              this.TripService.modifyBackend(this.trips).then(function (val) {
                _this29.isSuccess = true;
              })["catch"](function (err) {
                _this29.isErr = true;
              })["finally"](function () {
                setTimeout(function () {
    ...
    /***/
    function D4op(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _comment_section_comment_section_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      ...
      function DisplayPostsComponent_div_3_div_1_a_9_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function DisplayPostsComponent_div_3_div_1_button_10_Template(rf, ctx) {
        if (rf & 1) {
          var _r9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 15);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DisplayPostsComponent_div_3_div_1_button_10_Template_button_click_0_listener() {
            ...
            return ctx_r7.onDelete(post_r3._id);
          });
      ...
      function DisplayPostsComponent_div_3_div_1_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DisplayPostsComponent_div_3_div_1_Template_button_click_19_listener() {
            ...
            return ctx_r10.like(post_r3._id);
          })("mousedown", function DisplayPostsComponent_div_3_div_1_Template_button_mousedown_19_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r11);

            var ctx_r12 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2);

            return ctx_r12.mousedown();
          })("mouseup", function DisplayPostsComponent_div_3_div_1_Template_button_mouseup_19_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r11);

            var ctx_r13 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2);

            return ctx_r13.mouseup();
          })("mouseleave", function DisplayPostsComponent_div_3_div_1_Template_button_mouseleave_19_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r11);
      ...
      function DisplayPostsComponent_div_3_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
      ...
      function DisplayPostsComponent_p_4_Template(rf, ctx) {
        if (rf & 1) {
          ...
          value: function ngOnInit() {
            ...
            if (sessionStorage.getItem('username')) {
              ...
              this.route.params.subscribe(function (params) {
                _this30.input = params.query;

                if (_this30.input) {
                  _this30.postsService.searchPosts({
                    input: _this30.input
                  });

                  _this30.postsSub = _this30.postsService.getPostUpdateListener().subscribe(function (posts) {
                    _this30.isLoading = false;
                    _this30.posts = posts;
                  });
                } else {
                  _this30.HttpService.get('/user', null).then(function (res) {
                    _this30.user = res.user[0];

                    _this30.postsService.getRelevantPosts({
                      author: _this30.user.username,
                      follows: _this30.user.following,
                      tags: _this30.user.tags,
                      location: _this30.user.location
                    });
        ...
        _createClass(ProfileComponent, [{
          ...
          value: function getProfile() {
            ...
            this.httpService.get('/user', null).then(function (res) {
              ...
              _this32.propreties = Object.keys(_this32.User);
              _this32.values = Object.values(_this32.User); // takeout username

              _this32.propreties.shift();

              _this32.values.shift();
            })["catch"](function (err) {
              console.log(err);
            });
          ...
          value: function onDelete() {
            ...
            this.socketService.emit('deleteUser', sessionStorage.getItem('username'), function (data) {
              if (data.err) {
                ...
                _this33.sessionService.session();
          ...
          value: function onImagePicked(event) {
            ...
            reader.onload = function () {
              _this34.imagePreview = reader.result;
            };
    ...
    /***/
    function EZtS(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function Edcf(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function FvPJ(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function HSUS(module, __webpack_exports__, __webpack_require__) {
      "use strict";
        ...
        _createClass(AddVenuePopoverComponent, [{
          ...
          value: function ngAfterViewInit() {
            ...
            this.selectedOption_sub = this.CitySearchComponent.clickedOption.subscribe(function (location) {
              if (location) {
                _this36.selectedOption = location;

                _this36.CitySearchComponent.myControl.patchValue(location.name);
              }
            }); // fill form if user is editing venue
          ...
          value: function onSubmitCustom() {
            ...
            if (this.customVenueForm.valid) {
              ...
              var _iterator2 = _createForOfIteratorHelper(this.venueCategories),
                  _step2;
              ...
              this.TripService.modifyBackend(this.allTrips).then(function (response) {
                _this37.TripService.updateLocal(_this37.allTrips);
    ...
    /***/
    function HYNq(module, __webpack_exports__, __webpack_require__) {
      "use strict";
        ...
        _createClass(MapService, [{
          ...
          value: function buildMap() {
            ...
            this.map.on('load', function () {
              ...
              _this39.getFakeCenter();

              _this39.map.on('click', function (e) {
                var lng = e.lngLat.lng;
                var lat = e.lngLat.lat;

                _this39._clickLocation.next({
                  lng: lng,
                  lat: lat
                });
              });
          ...
          value: function getFakeCenter() {
            ...
            if (this.citySearchPresent) {
              ...
              this.OpenstreetmapService.reverseSearch(centerPoints.lng, centerPoints.lat).subscribe(function (response) {
                _this40._fakeCenterCity.next(response);
              }, function (err) {
                console.log(err);

                _this40._fakeCenterCity.next(err);
              });
            }
          }
    ...
    /***/
    function JVKH(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function LdkP(module, __webpack_exports__, __webpack_require__) {
      "use strict";
        ...
        _createClass(UserbuttonComponent, [{
          ...
          value: function onFollow() {
            ...
            this.HttpService.post('/user/follow', {
              ...
              _this42.result.followers.push(localStorage.getItem('username'));
            })["catch"](function (err) {
              console.log(err);
            });
          } // unfollow button
          ...
          value: function onUnfollow() {
            ...
            this.HttpService.post('/user/unfollow', {
              ...
              _this43.result.followers.splice(_this43.result.followers.indexOf(localStorage.getItem('username')), 1);
            })["catch"](function (err) {
              console.log(err);
            });
          }
    ...
    function NK7(module, __webpack_exports__, __webpack_require__) {
      ...
      var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! @angular/common/http */
      "IheW"); // http service that gives httpclient to everything
      ...
      var HttpService = /*#__PURE__*/function () {
        ...
        _createClass(HttpService, [{
          ...
          value: function _delete(route, params) {
            ...
            return new Promise(function (resolve, reject) {
              _this44.http["delete"](serverRoute, {
                headers: {
          ...
          value: function post(route, params) {
            ...
            var serverRoute = this.serverURL + route;
            return new Promise(function (resolve, reject) {
              _this46.http.post(serverRoute, params).subscribe(function (res) {
                resolve(res);
              }, function (err) {
                reject(err);
              });
          ...
          value: function patch(route, params) {
            ...
            var serverRoute = this.serverURL + route;
            return new Promise(function (resolve, reject) {
              _this48.http.patch(serverRoute, {
                headers: {
                  authorization: localStorage.getItem('token') ? localStorage.getItem('token').toString() : 'monkas'
                },
                params: params
    ...
    /***/
    function O3zK(module, __webpack_exports__, __webpack_require__) {
      "use strict";
          ...
          value: function loginClicked() {
            ...
            if (!sessionStorage.getItem('username')) {
              ...
              this.SocketService.emit('login', credentials, function (data) {
                if (data.err || data === '') {
                  console.log(data.err);
                  _this49.login_err = true;

                  _this49.loginForm.get('password').reset();
                } else if (data.res) {
                  sessionStorage.setItem('username', data.res);
                  localStorage.setItem('token', data.token);
                  localStorage.setItem('username', data.res);

                  _this49.modalService.dismissAll();

                  _this49.sessionService.session();
    ...
    /***/
    function OM0W(module, __webpack_exports__, __webpack_require__) {
      "use strict";
        ...
        _createClass(RegistrationProcessComponent, [{
          ...
          value: function ngAfterViewInit() {
            ...
            this.clickLocation = this.MapService.clickLocation.subscribe(function (x) {
              _this51._progressUpdate.next({
                target: _this51.stepper.selectedIndex,
                coordinates: [x.lng, x.lat]
              });
            });
            this.stepper_sub = this.stepper.selectionChange.subscribe(function (x) {
              console.log(_this51.stepper.steps);

              if (x.selectedIndex != 0) {
                _this51.editable = false;
                _this51.isDone = false;

                _this51.MapService.showMarker(x.selectedIndex);
              }
            });
          }
        }, {
          ...
          value: function savePreferences() {
            ...
            Promise.all([this.selector1.onSumbit(), this.selector2.onSumbit()]).then(function (responses) {
              _this52.isDone = true;
              setTimeout(function () {
                _this52.Router.navigate(['/home']);
              }, 500);
            })["catch"](function (err) {
              alert(err[0]); // window.location.reload()
            })["finally"](function () {
              _this52.isSaving = false;
            });
          }
        }, {
          key: "ngOnDestroy",
        ...
        _createClass(UserprofileComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.searchUser(this.url).then(function (result) {
              return _this53.content = result.users[0];
            });
          ...
          value: function searchUser(username) {
            ...
            return new Promise(function (resolve) {
              _this54.SearchService.userSearch(username).then(function (result) {
                console.log(result);
                resolve(result);
              });
            });
          ...
          value: function onFollow() {
            ...
            this.HttpService.post('/user/follow', {
              ...
              // add the follower in current content
              _this55.content.followers.push(_this55.selfUsername);
            })["catch"](function (err) {
              console.log(err);
            });
          } // unfollow button
          ...
          value: function onUnfollow() {
            ...
            this.HttpService.post('/user/unfollow', {
              ...
              // remove the follower from current content
              _this56.content.followers.splice(_this56.content.followers.indexOf(_this56.selfUsername), 1);
            })["catch"](function (err) {
              console.log(err);
            });
          }
    ...
    /***/
    function PAeE(module, __webpack_exports__, __webpack_require__) {
      "use strict";
        ...
        _createClass(VenueButtonComponent, [{
          ...
          value: function addToTrip(event) {
            ...
            this.SearchService.formatDetails(this.result.venue.id).then(function (result) {
              ...
              if (event.length && _this58.trips) {
                event.map(function (option) {
                  _this58.trips[option.value.trip].schedule[option.value.day].venues.push({
                ...
                _this58.TripService.modifyBackend(_this58.trips).then(function (val) {
                  _this58.isSuccess = true;
                })["catch"](function (err) {
                  _this58.isErr = true;
                });
              }
    ...
    /***/
    function PiFF(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function QeH8(module, __webpack_exports__, __webpack_require__) {
      "use strict";
        ...
        _createClass(SocketService, [{
          ...
          value: function listen(eventName) {
            ...
            return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (sub) {
              _this59.socket.on(eventName, function (data) {
                sub.next(data);
              });
            });
          }
          ...
          value: function emitO(eventName, data) {
            ...
            return new Promise(function (resolve, reject) {
              if (!_this60.socket) {
                ...
                _this60.socket.emit(eventName, data, function (ack) {
                  resolve(ack);
                });
              }
            });
          ...
          value: function once(eventName) {
            ...
            return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (sub) {
              _this61.socket.once(eventName, function (data) {
                sub.next(data);
              });
            });
          }
    ...
    /***/
    function STwT(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var AppComponent = /*#__PURE__*/function () {
        function AppComponent(FriendlistService, SessionService, SocketService, MapService) {
          ...
          this.openChatWidgetsSub = this.FriendlistService.openWidgets.subscribe(function (x) {
            return _this62.openChatWidgets = x;
          });
          this.sessionStateSub = this.SessionService.sessionState.subscribe(function (x) {
            _this62.sessionState = x;

            if (_this62.sessionState) {// this.FriendlistService.getNotifications()
            }
          });
        }
        ...
        _createClass(CommentsService, [{
          ...
          value: function addComment(newComment, postId) {
            ...
            this.http.post(this.url, {
              ...
              var postIndex = _this63.PostService.posts.findIndex(function (p) {
                return p._id === postId;
              });

              _this63.PostService.posts[postIndex].comments.push(comment);

              _this63.PostService.updatePosts(_this63.PostService.posts);
            });
          }
          ...
          value: function reply(replyContent) {
            ...
            this.http.put(this.url + replyContent.commentId, {
              ...
              _this64.PostService.posts[postIndex].comments[commentIndex].replies.push(responseData.reply);

              _this64.PostService.updatePosts(_this64.PostService.posts);
            });
          }
          /**edit  tree comment */
          ...
          value: function editComment(editContent) {
            ...
            this.http.put(this.url + 'edit/' + editContent.comment._id, {
              ...
              _this65.PostService.posts[postIndex].comments[commentIndex] = response.comment;

              _this65.PostService.updatePost(_this65.PostService.posts);
            });
          }
          /**like comment */
          ...
          value: function likeComment(likeContent) {
            ...
            if (likeContent.replyId) {
              var _replyIndex = this.PostService.posts[postIndex].comments[commentIndex].replies.findIndex(function (r) {
            ...
            this.http.put(this.url + 'like/' + likeContent.commentId, {
              ...
              if (likeContent.replyId) {
                _this66.PostService.posts[postIndex].comments[commentIndex].replies[replyIndex].likes = response.likes;
              } else {
                _this66.PostService.posts[postIndex].comments[commentIndex].likes = response.likes;
              }

              _this66.PostService.updatePost(_this66.PostService.posts);
            });
          }
          ...
          value: function deleteComment(deleteContent) {
            ...
            if (deleteContent.replyId) {
              var _replyIndex2 = this.PostService.posts[postIndex].comments[commentIndex].replies.findIndex(function (r) {
            ...
            this.http.put(this.url + 'delete/' + deleteContent.commentId, {
              ...
              var newPosts = _this67.PostService.posts;
              ...
              _this67.postsUpdated.next(newPosts);
            });
          }
        }]);
    ...
    /***/
    function VDfD(module, __webpack_exports__, __webpack_require__) {
      "use strict";
        ...
        _createClass(ScrollToTopComponent, [{
          ...
          value: function scrollToTop() {
            ...
            Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["interval"])(interval).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["scan"])(function (acc, curr) {
              ...
              return _this68.el.scrollTop = position;
    ...
    /***/
    function VX6k(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function W524(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var TripService = /*#__PURE__*/function () {
        function TripService(HttpService, SessionService) {
          ...
          this.sessionState_sub = this.SessionService.sessionState.subscribe(function (state) {
            if (state) {
              _this69.sessionState = state;

              _this69.HttpService.get('/user', {}).then(function (response) {
                if (response.user) {
                  _this69._trips.next(response.user[0].trips);
                }
              })["catch"](function (err) {
                console.log(err);
              });
        ...
        _createClass(TripService, [{
          ...
          value: function modifyBackend(triparr) {
            ...
            return new Promise(function (resolve, reject) {
              _this70.HttpService.patch('/user/edit', {
                username: localStorage.getItem('username'),
                proprety: 'trips',
                newProprety: triparr
              }).then(function (response) {
                _this70._trips.next(triparr);
    ...
    /***/
    function a1cW(module, __webpack_exports__, __webpack_require__) {
      "use strict";
          ...
          value: function logout() {
            ...
            if (sessionStorage.getItem('username')) {
              this.SocketService.emit('logout', sessionStorage.getItem('username'), function (data) {
                if (data.res) {
                  _this73.SessionService.session();
                }
              });
            }
    ...
    /***/
    function b74p(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function bDK8(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var TripmodalComponent = /*#__PURE__*/function () {
        ...
        _createClass(TripmodalComponent, [{
          ...
          value: function checkName(control) {
            ...
            return new Promise(function (resolve, reject) {
              _this74.HttpService.get('/user', {}).then(function (response) {
          ...
          value: function onSubmit(data) {
            ...
            if (typeof valid == 'string') {
              ...
              this.HttpService.patch('/user/edit', {
                ...
                if (response.message) {
                  _this75.dialogRef.close(new _models_trip_model__WEBPACK_IMPORTED_MODULE_0__["tripModel"](data.start, data.end, data.name));
                }
              })["catch"](function (err) {
                console.log(err);
              })["finally"](function () {
    ...
    /***/
    function ciVQ(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function fGHt(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function hZyq(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function hihI(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function ijTB(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var RegistrationComponent = /*#__PURE__*/function () {
        ...
        _createClass(RegistrationComponent, [{
          ...
          value: function forbiddenUsernames(control) {
            ...
            return new Promise(function (resolve, reject) {
              _this77.SocketService.emit('searchUser', [control.value], function (res) {
                if (res.res) {
                  resolve({
                ...
                this.SocketService.emit('createUser', data, function (res) {
                  ...
                  if (res.err) {
                    alert("an error occured ".concat(res.err));
                      ...
                      _this78.sessionService.session();

                      _this78.modalService.dismissAll();

                      _this78.stepper.next();
      ...
      var SearchService = /*#__PURE__*/function () {
        function SearchService(HttpClient, foursquareService) {
          ...
          this.updateCategories().then(function (x) {
            _this79._categoryTree.next(x);

            _this79._categorySet.next(_this79.treeValues.categorySet);
          });
          this.currentSearch = null;
        ...
        _createClass(SearchService, [{
          ...
          value: function foursquareSearchVenues(query, latLng) {
            ...
            return new Promise(function (resolve, reject) {
              _this80.foursquareService.searchVenues(query, latLng.toStringReorder(2)).subscribe(function (result) {
                resolve(result);
              }, function (err) {
                reject(err);
              });
          ...
          value: function userSearch(query) {
            ...
            return new Promise(function (resolve, reject) {
              _this81.HttpClient.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].travelnet.searchUsers, {
                headers: {
                  authorization: localStorage.getItem('token') ? localStorage.getItem('token').toString() : 'monkas'
                },
                params: {
          ...
          value: function formatDetails(query) {
            ...
            return new Promise(function (resolve, reject) {
              _this82.foursquareService.getDetails(query).subscribe(function (result) {
                resolve(result);
              }, function (err) {
                reject(err);
              });
              ...
              searchType.then(function (result) {
                if (result[0].response.totalResults != 0) {
                  result[0].response.groups[0].items.forEach(function (venue) {
                    _this83.search.content.venues.push(venue);
                  });
                } else {
                  _this83.search.content.venues = [];
                }

                if (sessionStorage.getItem('username')) {
                  if (result[1].users) {
                    result[1].users.forEach(function (user) {
                      _this83.search.content.users.push(user);
                    });
                  }
                } else {
                  _this83.search.content.users.push({
                    username: 'warning',
                ...
                _this83.search = {
                  ...
                  content: _this83.search.content
                };

                _this83._searchTab.next(_this83.search);
          ...
          value: function updateCategories() {
            ...
            return new Promise(function (resolve, reject) {
              _this84.foursquareService.updateCategories().subscribe(function (x) {
                _this84.initiateTree(x.response.categories);
          ...
          value: function initiateTree(data) {
            ...
            data.forEach(function (category) {
              if (category.categories.length === 0) {
                ...
                _this85.treeValues.categorySet.add(category.id);
              } else if (category.categories.length !== 0) {
                _this85.treeValues.categorySet.add(category.id);

                _this85.initiateTree(category.categories);
              }
            });
          }
        }, {
        ...
        _createClass(SearchBarComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.fakeCenter_sub = this.MapService.fakeCenter.subscribe(function (coord) {
              _this86.fakeCenter = coord ? coord : _environments_environment_dev__WEBPACK_IMPORTED_MODULE_0__["environment"].montrealCoord;
            });
            this.foursquareCategory_sub = this.SearchService.categoryTree.subscribe(function (cats) {
              _this86.categories = cats;
            });
          }
        }, {
          key: "ngAfterViewInit",
          value: function ngAfterViewInit() {
            ...
            this.clickedOption_sub = this.CitySearchComponent.clickedOption.subscribe(function (city) {
              if (city) {
                _this87.clickedOption = city;
              } else {
                _this87.clickedOption = null;
              }
            });
            this.ActivatedRoute.queryParams.subscribe(function (params) {
              ...
              if (!params.lng) {
                ...
                _this87.CitySearchComponent._clickedOptionLocal = new src_app_models_geocodeResp_model__WEBPACK_IMPORTED_MODULE_5__["geocodeResponseModel"](_this87.CitySearchComponent.myControl.value, [_this87.fakeCenter.lng, _this87.fakeCenter.lat]);
              } else {
                _this87.OpenstreetmapService.reverseSearch(params.lng, params.lat).subscribe(function (response) {
                  if (response.features[0]) {
                    _this87.CitySearchComponent.myControl.patchValue(response.features[0].properties.address.city + ',' + response.features[0].properties.address.country);
                  }
                });
              }

              if (params.query) {
                _this87.searchBarForm.get('venueName').setValue(params.query); // if url contains query


                if (!_this87.SearchService.currentSearch) {
                  _this87.loading = true;
                  var coord = params.lng ? new _models_coordinates__WEBPACK_IMPORTED_MODULE_2__["CustomCoordinates"](params.lng, params.lat) : _this87.MapService.getCenter();

                  _this87.SearchService.enterSearch(params.query, _this87.SearchService.mainSearch(params.query, coord), coord)["finally"](function () {
                    _this87.loading = false;
                  });
                }
              }
            });
          ...
          value: function onSubmit() {
            ...
            if (this.searchBarForm.valid && this.CitySearchComponent.myControl.valid) {
              ...
              this.SearchService.enterSearch(this.searchBarForm.get('venueName').value, this.SearchService.mainSearch(this.searchBarForm.get('venueName').value, coord), coord).then(function () {
                _this88.SearchService.currentSearch = {
                  query: _this88.searchBarForm.get('venueName').value,
                  lng: coord.lng,
                  lat: coord.lat,
                  category: _this88.defaultCategory
                };

                _this88.router.navigate(['search'], {
                  queryParams: {
                    query: _this88.searchBarForm.get('venueName').value,
                    lng: coord.lng,
                    lat: coord.lat,
    ...
    /***/
    function lumE(module, __webpack_exports__, __webpack_require__) {
      "use strict";
        ...
        _createClass(ChatwidgetComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.socketService.emit('initChatroom', {
              ...
              if (data.err) {
                ...
                data.messages.forEach(function (message) {
                  var ul = _this89.renderer.createElement('ul');

                  ul.innerHTML = "".concat(message.sender === _this89.username ? 'you' : message.sender, ": ").concat(message.content);

                  _this89.renderer.appendChild(_this89.div.nativeElement, ul);
                });
              }
            });
            ...
            this.socketService.listen('message_res').subscribe(function (data) {
              if (_this89.roomId == data.res.roomId) {
                var ul = _this89.renderer.createElement('ul');

                ul.innerHTML = "".concat(data.res.sender === _this89.username ? 'you' : data.res.sender, ": ").concat(data.res.content);
    ...
    /***/
    function qF1r(module, __webpack_exports__, __webpack_require__) {
      "use strict";
        ...
        _createClass(AddPostComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.route.paramMap.subscribe(function (paramMap) {
              if (paramMap.has('postId')) {
                _this91.mode = 'edit';
                _this91.postId = paramMap.get('postId');
                _this91.isLoading = true;

                _this91.postsService.getPost(_this91.postId).subscribe(function (postData) {
                  ...
                  _this91.form.setValue({
                    location: _this91.post.location,
                    title: _this91.post.title,
                    content: _this91.post.content,
                    image: _this91.post.imagePath,
                    tags: _this91.post.tags
                  });

                  _this91.imagePreview = _this91.post.imagePath;
                  _this91.tags = _this91.post.tags;
                  _this91.location = _this91.post.location;
                });
              } else {
                _this91.mode = 'create';
                _this91.postId = null;
          ...
          value: function ngAfterViewChecked() {
            ...
            if (this.CitySearchComponent && !this.checkedOnce) {
              this.clickedOption_sub = this.CitySearchComponent.clickedOption.subscribe(function (city) {
                if (city) {
                  _this92.clickedOption = city;
                } else {
                  _this92.clickedOption = null;
                }
              });
          ...
          value: function onImagePicked(event) {
            ...
            reader.onload = function () {
              _this93.imagePreview = reader.result;
            };
    ...
    /***/
    function tuAr(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var CitySearchComponent = /*#__PURE__*/function () {
        ...
        _createClass(CitySearchComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.ActivatedRoute.queryParams.subscribe(function (params) {
              if (params.lng) {
                _this94.OpenstreetmapService.reverseSearch(params.lng, params.lat).subscribe(function (res) {
                  if (res.features[0]) {
                    _this94.myControl.patchValue(_this94.removeMiddle(res.features[0].properties.display_name, 0));

                    _this94._clickedOptionLocal = new _models_geocodeResp_model__WEBPACK_IMPORTED_MODULE_0__["geocodeResponseModel"](_this94.myControl.value, res.features[0].geometry.coordinates);

                    _this94._clickedOption.next(_this94._clickedOptionLocal);
                  }
                });
              }
            ...
            this.searched = this.myControl.valueChanges.subscribe(function (x) {
              _this94._clickedOptionLocal = null;
              clearTimeout(_this94.timeout);
              _this94.timeout = setTimeout(function () {
                _this94.isLoading = true;

                _this94._autoSuggested.next([{}]);

                _this94.openstreetmap_sub = _this94.OpenstreetmapService.citySearch(x.toString()).subscribe(function (response) {
                  _this94.isLoading = false;
                  var searchResults = [];
                  response.features.forEach(function (element) {
                    var name = _this94.removeMiddle(element.properties.display_name, 1);
                  ...
                  _this94._autoSuggested.next(searchResults);
                }, function (err) {
                  _this94.isLoading = false;
                  console.log(err);
                });
            ...
            if (this.getFakeCenterCity) {
              ...
              this.fakeCenterCity_sub = this.MapService.fakeCenterCity.subscribe(function (res) {
                if (res.features) {
                  _this94.placeholder = 'Region';

                  _this94.myControl.patchValue(_this94.removeMiddle(res.features[0].properties.display_name, 1));

                  _this94._clickedOptionLocal = new _models_geocodeResp_model__WEBPACK_IMPORTED_MODULE_0__["geocodeResponseModel"](_this94.myControl.value, res.features[0].geometry.coordinates);

                  _this94._clickedOption.next(_this94._clickedOptionLocal);
                } else {
                  _this94.myControl.patchValue('');

                  _this94.placeholder = 'No city found';
                }
              });
            }
          }
    ...
    function vY5A(module, __webpack_exports__, __webpack_require__) {
      ...
      var _components_tabs_mytrip_mytrip_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./components/tabs/mytrip/mytrip.component */
      "/mFC");
      /* harmony import */


      var _components_myaccount_myaccount_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./components/myaccount/myaccount.component */
      "AKBL");
      /* harmony import */


      var _components_tabs_searchresults_searchresults_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./components/tabs/searchresults/searchresults.component */
      "a1cW");
      /* harmony import */


      var _components_venue_venue_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ./components/venue/venue.component */
      "Bg0t");
      /* harmony import */
      ...
      var _components_userprofile_userprofile_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! ./components/userprofile/userprofile.component */
      "P1Wc");
      /* harmony import */


      var _components_add_post_add_post_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      /*! ./components/add-post/add-post.component */
      "qF1r");

      var routes = [{
        path: 'create',
        component: _components_add_post_add_post_component__WEBPACK_IMPORTED_MODULE_11__["AddPostComponent"]
      }, {
        path: 'edit/:postId',
        component: _components_add_post_add_post_component__WEBPACK_IMPORTED_MODULE_11__["AddPostComponent"]
      }, {
      ...
      {
        path: 'mytrip',
        component: _components_tabs_mytrip_mytrip_component__WEBPACK_IMPORTED_MODULE_5__["MytripComponent"],
        children: [{
          path: '**',
          component: _components_tabs_mytrip_mytrip_component__WEBPACK_IMPORTED_MODULE_5__["MytripComponent"]
        }]
        ...
        path: 'myaccount',
        component: _components_myaccount_myaccount_component__WEBPACK_IMPORTED_MODULE_6__["MyaccountComponent"]
      }, {
        path: 'search',
        component: _components_search_bar_search_bar_component__WEBPACK_IMPORTED_MODULE_9__["SearchBarComponent"],
        children: [{
          path: 'venue/:query',
          component: _components_venue_venue_component__WEBPACK_IMPORTED_MODULE_8__["VenueComponent"]
        }, {
          path: 'user/:query',
          component: _components_userprofile_userprofile_component__WEBPACK_IMPORTED_MODULE_10__["UserprofileComponent"]
        }, {
          path: '**',
          component: _components_tabs_searchresults_searchresults_component__WEBPACK_IMPORTED_MODULE_7__["SearchresultsComponent"]
        }]
      }, {
        path: '',
        redirectTo: 'mytrip',
    ...
    function woXb(module, __webpack_exports__, __webpack_require__) {
        ...
        _createClass(AddPostService, [{
          ...
          value: function getPosts() {
            ...
            this.http.get(this.url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (postData) {
              ...
              _this95.posts = transformedPosts;

              _this95.postsUpdated.next(_this95.posts);
            });
          }
        }, {
          ...
          value: function getRelevantPosts(UserPref) {
            ...
            this.http.post(this.url + 'getSpecific/', UserPref).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (postData) {
              ...
              _this96.posts = transformedPosts;

              _this96.postsUpdated.next(_this96.posts);
            });
          }
        }, {
          key: "searchPosts",
          value: function searchPosts(input) {
            ...
            this.http.post(this.url + 'getOne', input).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (postData) {
              ...
              _this97.posts = transformedPosts;
              console.log(_this97.posts);

              _this97.postsUpdated.next(_this97.posts);
            });
          }
        }, {
          ...
          value: function addPost(newPost) {
            ...
            this.http.post(this.url, postData, {
              ...
              _this98.posts.push(post);

              _this98.postsUpdated.next(_this98.posts);

              _this98.router.navigate(['/']);

              console.log(_this98.posts);
            });
          }
        }, {
          key: "updatePost",
          value: function updatePost(newPost) {
            ...
            this.http.put(this.url + newPost._id, postData).subscribe(function (response) {
              var updatedPosts = _toConsumableArray(_this99.posts);
              ...
              _this99.posts = updatedPosts;

              _this99.postsUpdated.next(_this99.posts);

              _this99.router.navigate(['/']);
            });
          }
        }, {
          key: "deletePost",
          value: function deletePost(postId) {
            ...
            this.http["delete"](this.url + postId).subscribe(function () {
              var updatedPosts = _this100.posts.filter(function (post) {
                return post._id !== postId;
              });

              _this100.posts = updatedPosts;

              _this100.postsUpdated.next(_this100.posts);
            });
          }
        }, {
          key: "likePost",
          value: function likePost(postId, username) {
            ...
            this.http.put(this.url + 'like/' + postId, {
              ...
              _this101.posts[updatedPostIndex].likes = response.likes;

              _this101.postsUpdated.next(_this101.posts);
            });
          }
        }, {
          key: "updatePosts",
      ...
      AddPostService.ɵfac = function AddPostService_Factory(t) {
        return new (t || AddPostService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"]));
      };
      ...
      function SidebarComponent_div_0_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SidebarComponent_div_0_Template_button_click_1_listener() {
            ...
            return ctx_r7.window = !ctx_r7.window;
          });
        ...
        _createClass(SidebarComponent, [{
          ...
          value: function ngAfterViewInit() {
            ...
            this.windowSub = this.FriendlistService.windowSize.subscribe(function (windowWidth) {
              if (windowWidth <= _this102.drawer._width) {
                if (windowWidth < 500 || window.innerWidth) {
                  _this102.window = false;
                } else {
                  _this102.Styles.width = "".concat(windowWidth * 0.96, "px");
                }
              } else {
                _this102.window = true;
              }
            });
          }
        }, {
